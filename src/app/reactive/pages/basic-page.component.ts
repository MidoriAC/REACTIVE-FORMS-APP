...
export class BasicPageComponent {
  // Cuando se trabaje con form reactivos hay que crear un grupo de fgormulariios
  //Simpre importar el ReactiveFromsModule si no no funcionará nada
  //*Forma con FormGroup
  ...
  onSave(): void {
    if (this.myForm().invalid) {
      this.myForm().markAllAsTouched(); //Este es para que todos los campos si no esten lleno salte el mensaje de error, pero se deb trahbajar las validadciones con la directiva if en cada uno de los items primero
      return;
    }
